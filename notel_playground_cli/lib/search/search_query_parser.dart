...
///   modified:2025-08-01       — last modified date / range / comparison
///   startswith:'start zol'    — body starts with value (quote for multi-word)
///   contains:value            — body or title contains value
///   contains(a, b)            — multi-term AND matching (both terms required)
///   contains(a | b)           — multi-term OR matching (either term matches)
///   term1 && term2            — explicit AND between terms
///   'phrase'                  — body or title contains phrase
///   word                      — body or title contains word
///   term1 || term2            — OR between terms/phrases
///   -word / -'phrase'         — exclude word or phrase
class SearchQueryParser {
  ...
  /// Splits input into tokens respecting single-quoted strings and parenthesis.
